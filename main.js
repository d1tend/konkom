...
const cardAddArr1 = Array.from(document.querySelectorAll(".card__add"));
const cartNum1 = document.querySelector("#cart_num");
...
myCart.products = cardAddArr1.forEach((cardAdd) => {
